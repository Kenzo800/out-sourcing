...
export default function ServicesSection() {
  return (
    <div className="bg-gray-100 py-24 sm:py-32 relative isolate">
      ...
      >
        <div
          className="relative left-[calc(40%-5rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[-15deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(30%-10rem)] sm:w-[50rem]"
          style={{
            clipPath:
      ...
      >
        <div
          className="relative left-[calc(80%-5rem)] aspect-[1155/678] w-[32rem] -translate-x-1/2 rotate-[20deg] bg-gradient-to-tr from-[#9089fc] to-[#ff80b5] opacity-25 sm:left-[calc(70%-5rem)] sm:w-[45rem]"
          style={{
            clipPath:
              'polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)',
          }}
